...
{		
    ...
    {           
		...
		case 'D':
			...
			if(proctype_value == ("Branding - General"||"Branding – Out of home"||"Technical – PO"||"Project/Plant/Non Plant Operations"||"Tour Bill"||"Kind Scheme (Retailor Meeting)"||"Kind Scheme (Gold & Silver)"||"Branding –Out of home (Vehicle Painting At NBH)"||"Consultant for Marketing Development"||"Mobile Van Technical PO")){
