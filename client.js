...
{	console.log("inside custom event handler");
	...
	if(pname == "RABill")
	{
		...
		if(firstParam = "Btn_Export_ItemJournal"){
				window.open(secondParam,firstParam,'resizable=yes,scrollbars=auto,width='+window1W+',height=320,left='+window1Y+',top='+window1X); 
		}
		
	}
	
	if(pname == "ServicePoInvoice")
	{
		if(firstParam = "Btn_calculateRetention"){
			document.getElementById("Btn_calculateRetention").click();
		}
	}
