	...
	switch(TabName){
		...
		console.log("inside tab1");
			switch(SheetIndex){				
				...
				setControlTop("Tab2","1147px");
				setControlHeight("FRM_NonPoInvoice","1510px");
				break;
				
				case '1':		//CTI
				setControlHeight("Tab1","135px");				
				setControlTop("Tab2","720px");
				setControlHeight("FRM_NonPoInvoice","1080px");
				break;
	...
	switch(activityName)
            {
				...
				setControlTop("Tab2","559px");
				setControlHeight("FRM_NonPoInvoice","930px");
				...
				//setControlEnabled("journalname",true);
